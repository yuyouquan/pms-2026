...
export const initialProjects = [
  ...
  {
    id: '12', name: 'CN5C-D8400_H992', type: PROJECT_TYPE_MACHINE,
    status: '在研', progress: 58, leader: '张三',
    markets: ['OP', 'TR'], androidVersion: 'Android 16', chipPlatform: 'MTK',
    spm: '李白,张三', updatedAt: '30分钟前', productLine: 'CAMON', productCategory: 'CAMON', productSeries: 'CAMON 50', tosVersion: 'tOS 16.3',
  ...
  {
    id: '13', name: 'CN5M-D8400_H993', type: PROJECT_TYPE_MACHINE,
    status: '转维', progress: 92, leader: '李四',
    markets: ['OP', 'RU'], androidVersion: 'Android 16', chipPlatform: 'MTK',
    spm: '王五', updatedAt: '4小时前', productLine: 'CAMON', productCategory: 'CAMON', productSeries: 'CAMON 50', tosVersion: 'tOS 16.4',
  ...
  {
    id: '14', name: 'CN6_H902', type: PROJECT_TYPE_MACHINE,
    status: '上市', progress: 100, leader: '赵六',
    markets: ['OP', 'TR', 'RU'], androidVersion: 'Android 16', chipPlatform: 'QCOM',
    spm: '赵六', updatedAt: '昨天', productLine: 'CAMON', productCategory: 'CAMON', productSeries: 'P', tosVersion: 'tOS 16.4',
  ...
  {
    id: '15', name: 'CN6C_H903', type: PROJECT_TYPE_MACHINE,
    status: '在研', progress: 67, leader: '孙七',
    markets: ['OP', 'IN'], androidVersion: 'Android 16', chipPlatform: 'QCOM',
    spm: '吴九', updatedAt: '6小时前', productLine: 'CAMON', productCategory: 'CAMON', productSeries: 'P', tosVersion: 'tOS 16.4',
  ...
  {
    id: '16', name: 'NT-X1', type: PROJECT_TYPE_MACHINE,
    status: '在研', progress: 62, leader: '李白',
    markets: ['OP', 'TR'], androidVersion: 'Android 16', chipPlatform: 'MTK',
    spm: '李欣', updatedAt: '2小时前', productLine: 'NOTE', productCategory: 'Note', productSeries: 'NOTE X', tosVersion: 'tOS 16.3',
  ...
  {
    id: '17', name: 'NT-X2', type: PROJECT_TYPE_MACHINE,
    status: '转维', progress: 88, leader: '王五',
    markets: ['OP', 'RU'], androidVersion: 'Android 16', chipPlatform: 'MTK',
    spm: '周宇', updatedAt: '1小时前', productLine: 'NOTE', productCategory: 'Note', productSeries: 'NOTE X', tosVersion: 'tOS 16.5',
  ...
  {
    id: '18', name: 'PV6-A', type: PROJECT_TYPE_MACHINE,
    status: '上市', progress: 100, leader: '周八',
    markets: ['OP'], androidVersion: 'Android 16', chipPlatform: 'UNISOC',
    spm: '王五', updatedAt: '今天', productLine: 'POVA', productCategory: 'POVA', productSeries: 'POVA 6', tosVersion: 'tOS 16.2',
  ...
  },
  {
    ...
    markets: [], androidVersion: 'Android 16', chipPlatform: 'MTK',
    spm: '张三,李白', updatedAt: '2小时前', productLine: 'tOS', productSeries: '16.X', osSeries: '16.X', tosVersion: '16.3',
    ...
    currentNode: 'MR2', versionType: 'Full',
  ...
  },
  {
    ...
    markets: [], androidVersion: 'Android 16', chipPlatform: 'MTK',
    spm: '张三', updatedAt: '1小时前', productLine: '平台技术', domain: '基础架构,测试', tosVersions: '16.0,16.1', tosVersion: 'tOS 16.0',
  ...
  },
  {
    ...
    markets: [], androidVersion: 'Android 16', chipPlatform: 'QCOM',
    spm: '王五', updatedAt: '3小时前', productLine: '影像算法', domain: '影像,测试', tosVersions: '16.1,16.2', tosVersion: 'tOS 16.1',
