...
const machineDates = (d: (string | null)[]): MilestoneNodes => withMachineDerivedMilestones({ conceptStart: d[0], str1: d[1], str2: d[1] && d[2] ? midpointDate(d[1], d[2]) : null, str3: d[2], str4: d[3], str4a: d[3] && d[4] ? midpointDate(d[3], d[4]) : null, str5: d[4], productLaunch: d[5], lifecycleEnd: d[6] })
