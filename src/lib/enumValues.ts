...
export function createInitialEnumRows(): EnumRowsByType {
  return {
    ...
    'product-series': singleSeedRows('product-series', ['示例系列A 60', '示例系列B 40', '示例系列D 50', '路标演示系列']),
    'research-mode': singleSeedRows('research-mode', ['自研', '外研', '联合研发']),
    ...
    'chip-mapping': seededRows('chip-mapping', [
      { chipCode: 'DEMOCHIP001', chipModel: 'DEMOSOC003', chipPlatform: '示例平台A' },
      { chipCode: 'DEMOCHIP003', chipModel: 'DEMOSOC007', chipPlatform: '示例平台A' },
      { chipCode: 'DEMOCHIP004', chipModel: 'DEMOSOC005', chipPlatform: '示例平台A' },
      { chipCode: 'DEMOCHIP005', chipModel: 'DEMOSOC011', chipPlatform: '示例平台B' },
      { chipCode: '示例路标芯片', chipModel: '示例路标芯片型号', chipPlatform: '示例芯片平台' },
    ]),
    ...
    'build-option': singleSeedRows('build-option', ['demo_build_01', 'demo_build_02', 'demo_build_03', 'demo_build_04', 'demo_build_05', 'demo_build_06', 'demo_build_07']),
    'build-market': singleSeedRows('build-market', ['op', 'tr']),
    'tmg-subdomain-mapping': seededRows('tmg-subdomain-mapping', [
      { domain: '示例架构组', subdomain: '无' },
      { domain: '示例性能组', subdomain: '无' },
      { domain: '示例质量组', subdomain: '无' },
      { domain: '示例体验组', subdomain: '无' },
      { domain: '示例应用领域', subdomain: '示例智能技术' },
      { domain: '示例应用领域', subdomain: '应用' },
      { domain: '示例应用领域', subdomain: '图形' },
      { domain: '示例应用领域', subdomain: '内核' },
      { domain: '示例应用领域', subdomain: '多媒体' },
      { domain: '示例通信领域', subdomain: '器件' },
      { domain: '示例通信领域', subdomain: '蜂窝' },
      { domain: '示例通信领域', subdomain: '短距' },
      { domain: '示例通信领域', subdomain: '功耗' },
      { domain: '示例集成领域', subdomain: '三方体验' },
      { domain: '示例集成领域', subdomain: 'GMS' },
      { domain: '其他', subdomain: '安全' },
      { domain: '其他', subdomain: 'AIOT' },
    ]),
    'core-value': singleSeedRows('core-value', ['追赶', '人无我有', '人有我有']),
    'android-version': singleSeedRows('android-version', ['Android 15', 'Android 16', 'Android 17', 'Android 18']),
    'package-mode-mapping': seededRows('package-mode-mapping', [
      { androidVersion: 'Android 16', chipModel: 'DEMOSOC003', packageMode: '整包' },
      { androidVersion: 'Android 17', chipModel: 'DEMOSOC007', packageMode: '分包' },
      { androidVersion: 'Android 17', chipModel: 'DEMOSOC005', packageMode: '整包' },
      { androidVersion: 'Android 17', chipModel: 'DEMOSOC011', packageMode: '分包' },
      { androidVersion: 'Android 18', chipModel: 'DEMOSOC007', packageMode: '整包' },
    ]),
  }
}
