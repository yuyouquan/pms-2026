import { PROJECT_CATEGORY_TOS_VERSION } from '@/constants/projectTypes'
...
export function mergeHrFormalMilestones(category: HrProjectCategory, source: object, manual?: object) {
  ...
  return { ...source, ...Object.fromEntries(HR_MANUAL_MILESTONE_KEYS[category].map(key => [key, dates[key] ?? null])) }
}
