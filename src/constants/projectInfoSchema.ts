...
export const TOS_PROJECT_INFO_FIELDS: ProjectInfoFieldDefinition[] = defineFields([
  ...
  { key: 'tosSystemAppDevRepresentative', label: '示例应用领域开发代表', group: 'team', inputType: 'people', requiredOnCreate: false, defaultVisible: false, hideable: true },
  { key: 'tosBasebandDevRepresentative', label: '示例通信领域开发代表', group: 'team', inputType: 'people', requiredOnCreate: false, defaultVisible: false, hideable: true },
  { key: 'tosIntegrationDevRepresentative', label: '示例集成领域开发代表', group: 'team', inputType: 'people', requiredOnCreate: false, defaultVisible: false, hideable: true },
