...
const MOCK_WORK_ITEMS: WorkItem[] = [
  { id: 'w1', type: '任务', name: 'STR2阶段功能开发', status: '进行中', stayDuration: 5, responsible: '演示用户01', planStartDate: '2026-03-20', planEndDate: '2026-04-05', actualStartDate: '2026-03-20', project: 'DEMO017-DEMOCHIP001_DEMOBOARD016', projectId: '1', priority: 'high', createdBy: '演示用户02', createdAt: '2026-03-18', planLevel: 'level1', taskName: 'STR2' },
  { id: 'w2', type: '任务', name: '性能优化方案评审', status: '待办', stayDuration: 3, responsible: '演示用户01', planStartDate: '2026-04-01', planEndDate: '2026-04-10', project: 'DEMO017-DEMOCHIP001_DEMOBOARD016', projectId: '1', priority: 'medium', createdBy: '演示用户03', createdAt: '2026-03-25', planLevel: 'level2', planType: '需求开发计划', taskName: '性能优化方案评审' },
  { id: 'w3', type: '需求', name: 'AI相机功能需求分析', status: '已完成', stayDuration: 0, responsible: '演示用户01', planStartDate: '2026-03-01', planEndDate: '2026-03-15', actualStartDate: '2026-03-02', actualEndDate: '2026-03-14', project: 'DEMO017-DEMOCHIP001_DEMOBOARD016', projectId: '1', priority: 'medium', createdBy: '演示用户01', createdAt: '2026-02-28' },
  { id: 'w4', type: '风险', name: '芯片供应链交期风险', status: '进行中', stayDuration: 12, responsible: '演示用户01', planStartDate: '2026-03-10', planEndDate: '2026-04-15', actualStartDate: '2026-03-10', project: 'DEMO013_DEMOBOARD010', projectId: '3', priority: 'high', createdBy: '演示用户04', createdAt: '2026-03-08' },
  { id: 'w5', type: '任务', name: 'tOS16内核适配', status: '逾期', stayDuration: 8, responsible: '演示用户01', planStartDate: '2026-03-15', planEndDate: '2026-03-28', actualStartDate: '2026-03-15', project: 'tOS16.1', projectId: '2', priority: 'high', createdBy: '演示用户02', createdAt: '2026-03-10', planLevel: 'level1', taskName: 'STR3' },
  { id: 'w6', type: '问题', name: '蓝牙模块兼容性问题', status: '待办', stayDuration: 2, responsible: '演示用户01', planStartDate: '2026-04-02', planEndDate: '2026-04-08', project: 'DEMO017-DEMOCHIP001_DEMOBOARD016', projectId: '1', priority: 'high', createdBy: '演示用户05', createdAt: '2026-04-01' },
  { id: 'w7', type: '任务', name: '测试用例编写', status: '已完成', stayDuration: 0, responsible: '演示用户01', planStartDate: '2026-03-05', planEndDate: '2026-03-20', actualStartDate: '2026-03-06', actualEndDate: '2026-03-19', project: 'tOS16.1', projectId: '2', priority: 'low', createdBy: '演示用户01', createdAt: '2026-03-03', planLevel: 'level2', planType: '在研版本火车计划', taskName: '测试用例编写' },
  { id: 'w8', type: '需求', name: 'NFC功能适配需求', status: '待办', stayDuration: 1, responsible: '演示用户01', planStartDate: '2026-04-05', planEndDate: '2026-04-20', project: 'DEMO020-DEMOCHIP002_DEMOBOARD002', projectId: '7', priority: 'medium', createdBy: '演示用户07', createdAt: '2026-04-02' },
  { id: 'w9', type: '任务', name: '版本集成测试', status: '逾期', stayDuration: 15, responsible: '演示用户01', planStartDate: '2026-03-01', planEndDate: '2026-03-25', actualStartDate: '2026-03-02', project: 'DEMO-TECH-V2', projectId: '9', priority: 'high', createdBy: '演示用户02', createdAt: '2026-02-25', planLevel: 'level1', taskName: 'STR5' },
  { id: 'w10', type: '风险', name: '人力资源不足风险', status: '进行中', stayDuration: 6, responsible: '演示用户01', planStartDate: '2026-03-20', planEndDate: '2026-04-30', actualStartDate: '2026-03-22', project: 'DEMO-OPS', projectId: '10', priority: 'medium', createdBy: '演示用户05', createdAt: '2026-03-18' },
  { id: 'w11', type: '任务', name: '代码评审流程优化', status: '已完成', stayDuration: 0, responsible: '演示用户02', planStartDate: '2026-03-10', planEndDate: '2026-03-30', actualStartDate: '2026-03-11', actualEndDate: '2026-03-28', project: 'DEMO-OPS', projectId: '10', priority: 'low', createdBy: '演示用户02', createdAt: '2026-03-08', planLevel: 'level2', planType: '1+N MR版本火车计划', taskName: '代码评审流程优化' },
  { id: 'w12', type: '任务', name: 'CI/CD流水线搭建', status: '进行中', stayDuration: 4, responsible: '演示用户02', planStartDate: '2026-03-25', planEndDate: '2026-04-15', actualStartDate: '2026-03-26', project: 'DEMO-OPS', projectId: '10', priority: 'high', createdBy: '演示用户05', createdAt: '2026-03-22', planLevel: 'level1', taskName: 'STR2' },
]
