...
const MR_TRAIN_DATA = [
  // tOS版本项目 - tOS16.0（挂在 tOS16.3.50 版本组下）
  {
    ...
    projectName: 'tOS16.1', projectId: '2', projectType: 'tOS版本项目', isMada: '-', madaMarket: '-',
    spm: '演示用户01', contact: '演示用户02', tpm: '演示用户04', mrType: 'FR', projectVersion: '16.0.001', crossTestType: '标准',
    branch: '16.0_main',
  ...
  // tOS16.3.50 - 示例平台B（整机项目）
  {
    key: '1', tosVersion: 'tOS16.3.50', chipPlatform: '示例平台B', productLine: '高端系列', market: 'OP',
    projectName: 'DEMO017-DEMOCHIP001_DEMOBOARD016', projectId: '1', projectType: PROJECT_TYPE_MACHINE_PHONE, isMada: '是', madaMarket: 'GMS',
    spm: '演示用户07', contact: '演示用户01', tpm: '演示用户03', mrType: 'FR', projectVersion: '16.3.050.01', crossTestType: '标准',
  ...
  {
    key: '2', tosVersion: 'tOS16.3.50', chipPlatform: '示例平台B', productLine: '高端系列', market: 'TR',
    projectName: 'DEMO017-DEMOCHIP001_DEMOBOARD016', projectId: '1', projectType: PROJECT_TYPE_MACHINE_PHONE, isMada: '否', madaMarket: '-',
    spm: '演示用户07', contact: '演示用户01', tpm: '演示用户03', mrType: 'MR1', projectVersion: '16.3.050.02', crossTestType: '标准',
    branch: '16.3.050_MR1',
  ...
  {
    key: '3', tosVersion: 'tOS16.3.50', chipPlatform: '示例平台B', productLine: '中端系列', market: 'RU',
    projectName: 'DEMO001-DEMOCHIP001_DEMOBOARD017', projectId: '12', projectType: PROJECT_TYPE_MACHINE_PHONE, isMada: '否', madaMarket: '-',
    spm: '演示用户01', contact: '演示用户02', tpm: '演示用户04', mrType: 'MR4', projectVersion: '16.3.050.03', crossTestType: '跨测',
    branch: '16.3.050_MR4',
  ...
  {
    key: '4', tosVersion: 'tOS16.3.50', chipPlatform: '示例平台B', productLine: '中端系列', market: 'OP',
    projectName: 'DEMO001-DEMOCHIP001_DEMOBOARD017', projectId: '12', projectType: PROJECT_TYPE_MACHINE_PHONE, isMada: '否', madaMarket: '-',
    spm: '演示用户01', contact: '演示用户02', tpm: '演示用户04', mrType: 'MR2', projectVersion: '16.3.050.04', crossTestType: '标准',
    branch: '16.3.050_MR2',
    act_版本规划_需求收集_start: '', act_版本规划_需求收集_end: '',
    act_版本规划_计划评审_start: '', act_版本规划_计划评审_end: '',
    act_版本开发_代码开发_start: '', act_版本开发_代码开发_end: '',
  ...
  // tOS16.3.50 - 示例平台A
  {
    key: '5', tosVersion: 'tOS16.3.50', chipPlatform: '示例平台A', productLine: '高端系列', market: 'OP',
    projectName: 'DEMO013_DEMOBOARD010', projectId: '3', projectType: PROJECT_TYPE_MACHINE_PHONE, isMada: '是', madaMarket: 'GMS',
    spm: '演示用户04', contact: '演示用户03', tpm: '演示用户05', mrType: 'MR1', projectVersion: '16.3.050.05', crossTestType: '标准',
    branch: '16.3.050_main',
  ...
  {
    key: '6', tosVersion: 'tOS16.3.50', chipPlatform: '示例平台A', productLine: '高端系列', market: 'TR',
    projectName: 'DEMO013_DEMOBOARD010', projectId: '3', projectType: PROJECT_TYPE_MACHINE_PHONE, isMada: '否', madaMarket: '-',
    spm: '演示用户04', contact: '演示用户03', tpm: '演示用户05', mrType: 'MR1', projectVersion: '16.3.050.06', crossTestType: '跨测',
    branch: '16.3.050_MR1',
  ...
  {
    key: '7', tosVersion: 'tOS16.3.50', chipPlatform: '示例平台A', productLine: '中端系列', market: 'OP',
    projectName: 'DEMO020-DEMOCHIP002_DEMOBOARD002', projectId: '7', projectType: PROJECT_TYPE_MACHINE_PHONE, isMada: '否', madaMarket: '-',
    spm: '演示用户02', contact: '演示用户04', tpm: '演示用户06', mrType: 'MR1', projectVersion: '16.3.050.07', crossTestType: '标准',
    branch: '16.3.050_MP',
    act_版本规划_需求收集_start: '', act_版本规划_需求收集_end: '',
    act_版本规划_计划评审_start: '', act_版本规划_计划评审_end: '',
    act_版本开发_代码开发_start: '', act_版本开发_代码开发_end: '',
  ...
  {
    key: '8', tosVersion: 'tOS16.3.50', chipPlatform: '示例平台A', productLine: '中端系列', market: 'IN',
    projectName: 'DEMO020-DEMOCHIP002_DEMOBOARD002', projectId: '7', projectType: PROJECT_TYPE_MACHINE_PHONE, isMada: '是', madaMarket: 'GMS',
    spm: '演示用户02', contact: '演示用户04', tpm: '演示用户06', mrType: 'MR1', projectVersion: '16.3.050.08', crossTestType: '标准',
    branch: '16.3.050_MP',
    act_版本规划_需求收集_start: '', act_版本规划_需求收集_end: '',
    act_版本规划_计划评审_start: '', act_版本规划_计划评审_end: '',
    act_版本开发_代码开发_start: '', act_版本开发_代码开发_end: '',
  ...
  // tOS16.3.50 - 示例平台C
  {
    key: '9', tosVersion: 'tOS16.3.50', chipPlatform: '示例平台C', productLine: '入门系列', market: 'OP',
    projectName: 'DEMO002-DEMOCHIP001_DEMOBOARD018', projectId: '13', projectType: PROJECT_TYPE_MACHINE_PHONE, isMada: '否', madaMarket: '-',
    spm: '演示用户03', contact: '演示用户06', tpm: '演示成员03', mrType: 'MR1', projectVersion: '16.3.050.09', crossTestType: '标准',
    branch: '16.3.050_main',
    act_版本规划_需求收集_start: '', act_版本规划_需求收集_end: '',
    act_版本规划_计划评审_start: '', act_版本规划_计划评审_end: '',
    act_版本开发_代码开发_start: '', act_版本开发_代码开发_end: '',
  ...
  {
    key: '10', tosVersion: 'tOS16.3.50', chipPlatform: '示例平台C', productLine: '入门系列', market: 'BR',
    projectName: 'DEMO002-DEMOCHIP001_DEMOBOARD018', projectId: '13', projectType: PROJECT_TYPE_MACHINE_PHONE, isMada: '否', madaMarket: '-',
    spm: '演示用户03', contact: '演示用户06', tpm: '演示成员03', mrType: 'MR1', projectVersion: '16.3.050.10', crossTestType: '跨测',
    branch: '16.3.050_MR1',
    act_版本规划_需求收集_start: '', act_版本规划_需求收集_end: '',
    act_版本规划_计划评审_start: '', act_版本规划_计划评审_end: '',
    act_版本开发_代码开发_start: '', act_版本开发_代码开发_end: '',
  ...
  {
    key: '11', tosVersion: 'tOS16.3.50', chipPlatform: '示例平台C', productLine: '入门系列', market: 'IN',
    projectName: 'DEMO003_DEMOBOARD011', projectId: '14', projectType: PROJECT_TYPE_MACHINE_PHONE, isMada: '否', madaMarket: '-',
    spm: '演示用户05', contact: '演示成员03', tpm: '演示用户02', mrType: 'MR1', projectVersion: '16.3.050.11', crossTestType: '标准',
    branch: '16.3.050_MR1',
    act_版本规划_需求收集_start: '', act_版本规划_需求收集_end: '',
    act_版本规划_计划评审_start: '', act_版本规划_计划评审_end: '',
    act_版本开发_代码开发_start: '', act_版本开发_代码开发_end: '',
