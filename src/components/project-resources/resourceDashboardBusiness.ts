...
export function dashboardBusinessTrend(analyses: readonly (DashboardAnalysis | undefined)[], accounting: AccountingAnalysis | undefined, mode: 'labor' | 'cost', grain: 'month' | 'week') {
