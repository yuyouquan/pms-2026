      ...
      <div className="flex">
        ...
        <aside className="pms-glass-surface w-60 border-r min-h-[calc(100vh-64px)]">
          <nav className="p-4">
            ...
            <a href="/config/level1-template" className="pms-template-nav-active flex items-center gap-3 px-3 py-2 text-sm rounded-md">
              <span>一级计划模板</span>
            </a>
            <a href="/config/level2-template" className="pms-template-nav flex items-center gap-3 px-3 py-2 text-sm text-gray-700 rounded-md"
