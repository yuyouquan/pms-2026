...
assert.equal(Number(planSource.match(/PLAN_STORE_VERSION\s*=\s*(\d+)/)?.[1]), 10, 'plan store preserves the V9 level-one migration and retires legacy level-three state')
