...
assert.match(enumUi, /const deleteType\s*=\s*selectedType[\s\S]{0,500}deleteEnumRow\(deleteType,\s*row\.id\)/, 'delete confirmation captures its own type before the asynchronous confirmation')
