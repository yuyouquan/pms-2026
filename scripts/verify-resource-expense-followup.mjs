...
const imported=sheet.parseNonLaborInvestmentRows([sheet.nonLaborSpreadsheetColumns(shrunk).slice(1).map(c=>c.title),['软件部','驱动开发','交通费','机票',250]],shrunk,subjects,departments,shrunk)
