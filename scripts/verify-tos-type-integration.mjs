...
const required = [
  ...
  ['src/containers/ProjectSpaceContainer.tsx', '上市迭代和维护子任务独立维护，仅最新发布版可编辑'],
  ['src/containers/ProjectSpaceContainer.tsx', '修订与发布仍在 ${effectiveTosLevel1Type} 操作'],
  ...
  ['src/hooks/useActivateProject.ts', 'setSelectedTosTypeTab'],
  ['src/containers/ProjectListContainer.tsx', 'useActivateProject'],
  ['src/containers/WorkbenchContainer.tsx', 'useActivateProject'],
