...
const hierarchy = [
  ...
  { id: 'str1', stableId: 'str1', parentId: 'concept', order: 2, taskName: 'STR1', planStartDate: '2026-01-05', planEndDate: '2026-01-20' },
...
assert.equal(milestones.find(row => row.id === 'str1')?.estimatedDays, 15, 'date pairs compute milestone duration')
