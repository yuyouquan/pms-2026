...
for (const kind of ['Machine', 'Tos', 'Technical', 'Capability']) {
  ...
  for (const budgetType of ['annual', 'projectEstimate', 'projectBudget']) {
    ...
    selected = undefined
    const render = () => elements(module.exports.default({ project, category: kind.toLowerCase(), budgetType }))
