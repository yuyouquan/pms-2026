...
for (const [key, value] of Object.entries(changed)) assert.equal(record(formal.id).versions.find(version => version.id === originalId).milestones[key], value, 'historical end dates are immutable')
