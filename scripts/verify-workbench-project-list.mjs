...
assert.match(source, /useSingleEnumOptions\(\s*statusEnumType,\s*\[\],\s*projectTypeFilter !== ['"]all['"],?\s*\)/, 'status quick filters use only current category enum options')
