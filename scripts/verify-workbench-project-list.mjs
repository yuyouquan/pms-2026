...
assert.match(source, /AppstoreOutlined[\s\S]{0,120}卡片视图/, 'card-view segment keeps its icon and visible text')
assert.match(source, /UnorderedListOutlined[\s\S]{0,120}列表视图/, 'list-view segment keeps its icon and visible text')
