...
// localStorage persists JSON, which omits optional properties set to undefined.
const durable=stores.map(store=>JSON.parse(JSON.stringify(store.getState().projects)))
stop()
