...
assert.match(projectSpaceSource, /fieldMode=\{projectPlanLevel === 'level1' && \(isWholeMachineProject \|\| isTosVersionProject\) \? 'hierarchical-flat' : 'legacy'\}/, 'governed project level1 comparison selects flat milestone fields')
